...
2. Once the project is open in Xcode, you can select a device (ex. iPhone 17 Pro) and run it on a simulator by pressing Cmd + R or clicking on the play button at the top-left corner of the screen.
